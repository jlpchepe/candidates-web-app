        ...
        return (
            ...
            >
                ...
                <Seccion title="Examen de analista"> 
                    <Row>
                        <LabeledDateInput label="Fecha" value={this.props.model.examenAnalistaFecha} onChange={value => this.props.setModel({ examenAnalistaFecha: value })} readonly={this.props.readonly}/>
                ...
                <Seccion title="Examen de ingeniero de pruebas"> 
                    <Row>
                        <LabeledDateInput label="Fecha" value={this.props.model.examenIngenieroPruebasFecha} onChange={value => this.props.setModel({ examenIngenieroPruebasFecha: value })} readonly={this.props.readonly}/>
                ...
                <Seccion title="Examen de administrador de proyectos"> 
                    <Row>
                        <LabeledDateInput label="Fecha" value={this.props.model.examenAdministradorProyectoFecha} onChange={value => this.props.setModel({ examenAdministradorProyectoFecha: value })} readonly={this.props.readonly}/>
                ...
                <Seccion title="Examen de soporte - BD"> 
                    <Row>
                        <LabeledDateInput label="Fecha" value={this.props.model.examenPracticoSoporteBdFecha} onChange={value => this.props.setModel({ examenPracticoSoporteBdFecha: value })} readonly={this.props.readonly}/>
                ...
                <Seccion title="Etapa de entrevistas">
                    <Row>
                        <LabeledDateInput label="Fecha con capital humano" value={this.props.model.entrevistaCapitalHumanoFecha} onChange={value => this.props.setModel({ entrevistaCapitalHumanoFecha: value })} readonly={this.props.readonly}/>
                    ...
                    <Row>
                        <LabeledDateInput label="Fecha con coordinador y equipo técnico" value={this.props.model.entrevistaCoordinadorYEquipoTecnicoFecha} onChange={value => this.props.setModel({ entrevistaCoordinadorYEquipoTecnicoFecha: value })} readonly={this.props.readonly}/>
                    ...
                    <Row>
                        <LabeledDateInput label="Fecha de entrevista en inglés" value={this.props.model.entrevistaInglesFecha} onChange={value => this.props.setModel({ entrevistaInglesFecha: value })} readonly={this.props.readonly}/>
                    ...
                    <Row>
                        <LabeledDateInput label="Fecha con gerente de área" value={this.props.model.entrevistaGerenteAreaFecha} onChange={value => this.props.setModel({ entrevistaGerenteAreaFecha: value })} readonly={this.props.readonly}/>
